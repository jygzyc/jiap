...
class JiapUIManager(
    ...
    private fun showSettingsDialog() {
        ...
        val port = server.currentPort
        val url = PluginUtils.buildServerUrl(port = port)
        ...
        portField = JTextField(port.toString(), 8)
        ...
        mcpAutoStartCheckbox!!.isSelected = PreferencesManager.getAutoStartMcp()
    ...
    private fun saveSettings() {
        ...
        if (newPort != null && newPort != server.currentPort && newPort in 1024..65535) {
        ...
        mcpAutoStartCheckbox?.let {
            PreferencesManager.setAutoStartMcp(it.isSelected)
        }
    }
