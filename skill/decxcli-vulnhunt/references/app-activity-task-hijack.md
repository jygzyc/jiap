...
```
1. decx ard app-manifest → 检查 manifest 中的任务栈相关属性
2. decx code class-source <Activity> → 搜索 setTaskAffinity/setTaskReparenting 调用
3. decx code xref-field "android:taskAffinity" → 读取 manifest 中的静态配置
