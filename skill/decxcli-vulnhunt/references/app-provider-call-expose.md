...
2. decx code class-source <ProviderClass> → 检查是否覆写 call() 方法
3. decx code xref-method "package.Provider.call(java.lang.String,java.lang.String,android.os.Bundle):android.os.Bundle" → 交叉引用追踪 call() 方法
