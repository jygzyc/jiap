...
```
1. decx code xref-method "android.app.PendingIntent.getActivity(...)" → 定位 PendingIntent 创建点
2. decx code xref-method "android.app.PendingIntent.getService(...)" → 追踪 getService
3. decx code xref-method "android.app.PendingIntent.getBroadcast(...)" → 追踪 getBroadcast
4. decx code xref-method "android.app.PendingIntent.send()" → 追踪 send 调用
