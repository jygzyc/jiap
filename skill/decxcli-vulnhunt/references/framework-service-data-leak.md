...
3. decx code xref-method "<ServiceImpl.getRunningAppProcesses(...)>" → 追踪 getRunningAppProcesses 调用
4. decx code xref-method "<ServiceImpl.getRecentTasks(...)>" → 追踪 getRecentTasks 调用
5. decx code xref-method "<ServiceImpl.getInstalledPackages(...)>" → 追踪 getInstalledPackages 调用
6. decx code xref-method "<ServiceImpl.getAccounts(...)>" → 追踪 getAccounts 调用
7. decx code xref-method "<ServiceImpl.getDeviceId(...)>" → 追踪 getDeviceId 调用
8. decx code xref-method "<ServiceImpl.getSerial(...)>" → 追踪 getSerial 调用
9. decx code xref-method "<ServiceImpl.getWifiInfo(...)>" → 追踪 getWifiInfo 调用
10. decx code class-source <ServiceImpl> → 识别返回数据的方法
