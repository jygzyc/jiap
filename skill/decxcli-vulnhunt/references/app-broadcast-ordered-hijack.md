...
```
1. decx code class-source <SendingComponentClass> → 定位发送有序广播的组件
2. decx code xref-method "package.Class.sendOrderedBroadcast(android.content.Intent,java.lang.String):void" → 交叉引用追踪
