...
2. decx code class-source <ServiceClass> → 检查 onStartCommand/onHandleIntent
3. decx code xref-method "package.Class.onHandleIntent(...):void" → 追踪 onHandleIntent 调用
4. decx code xref-method "package.Class.onStartCommand(...):int" → 追踪 onStartCommand 调用
