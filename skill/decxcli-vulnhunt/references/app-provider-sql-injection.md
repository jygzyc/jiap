...
2. decx code class-source <ProviderClass> → 检查 query() 中是否有 SQL 拼接
3. decx code xref-method "package.Provider.query(android.net.Uri,java.lang.String[],java.lang.String,java.lang.String[],java.lang.String):android.database.Cursor" → 交叉引用追踪 query 调用
4. decx code xref-method "package.Class.rawQuery(java.lang.String,java.lang.String[]):android.database.Cursor" → 追踪 rawQuery 调用
5. decx code xref-method "package.Class.execSQL(java.lang.String):void" → 追踪 execSQL 调用
