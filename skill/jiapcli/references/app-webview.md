...
2. 对每个 WebView Activity/Fragment：
   a. jiap code class-source <WebViewActivity> → 获取源码
...
3. 追踪数据流：
   jiap code xref-method "android.webkit.WebView.loadUrl(...)"
   jiap code xref-method "android.webkit.WebView.evaluateJavascript(...)"
4. 检查 URL 来源：
...
- Intent Scheme → [[app-intent]]
- Provider 文件共享 → [[app-provider]]
