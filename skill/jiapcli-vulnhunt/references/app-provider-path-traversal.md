...
2. jiap code class-source <ProviderClass> → 检查 openFile/openAssetFile 是否有路径校验
3. jiap code xref-method "package.Provider.openFile(android.net.Uri,java.lang.String):android.os.ParcelFileDescriptor" → 追踪 openFile 调用
4. jiap code xref-method "package.Class.getCanonicalPath():java.lang.String" → 追踪路径校验方法
