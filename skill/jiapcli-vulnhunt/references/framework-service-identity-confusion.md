...
4. jiap code xref-method "<package.Class.processForUser(...)>" → 对特定方法进行交叉引用追踪
5. jiap code xref-method "<package.Class.handleIncomingUser(...)>" → 追踪 handleIncomingUser 调用
6. jiap code class-source <ServiceImpl> → 搜索接受 userId/uid 参数的方法
