...
impl From<crate::rusty_dex::dex::classes::AnnotationVisibility> for AnnotationVisibility {
    fn from(value: crate::rusty_dex::dex::classes::AnnotationVisibility) -> Self {
        match value {
            crate::rusty_dex::dex::classes::AnnotationVisibility::Build => Self::Build,
            crate::rusty_dex::dex::classes::AnnotationVisibility::Runtime => Self::Runtime,
            crate::rusty_dex::dex::classes::AnnotationVisibility::System => Self::System,
            crate::rusty_dex::dex::classes::AnnotationVisibility::Unknown(value) => Self::Unknown(value),
        }
    }
}

impl TryFrom<&crate::rusty_dex::dex::classes::DexAnnotation> for AnnotationNode {
    type Error = MetadataConversionError;

    fn try_from(value: &crate::rusty_dex::dex::classes::DexAnnotation) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl TryFrom<&crate::rusty_dex::dex::encoded_value::EncodedAnnotation> for AnnotationNode {
    type Error = MetadataConversionError;

    fn try_from(
        value: &crate::rusty_dex::dex::encoded_value::EncodedAnnotation,
...
impl TryFrom<&crate::rusty_dex::dex::encoded_value::EncodedValue> for DexValue {
    type Error = MetadataConversionError;

    fn try_from(value: &crate::rusty_dex::dex::encoded_value::EncodedValue) -> Result<Self, Self::Error> {
        use crate::rusty_dex::dex::encoded_value::EncodedValue;
        Ok(match value {
