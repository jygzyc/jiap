...
pub enum DexError {
    ...
    Parser(crate::rusty_dex::error::DexError),
...
impl From<crate::rusty_dex::error::DexError> for DexError {
    fn from(e: crate::rusty_dex::error::DexError) -> Self {
        DexError::Parser(e)
    }
}
...
impl NestedClassIndex {
    fn analyze(dex_files: &[crate::rusty_dex::dex::file::DexFile]) -> Self {
    ...
    fn declared_parent(class: &crate::rusty_dex::dex::classes::ClassDefItem) -> Option<String> {
...
pub struct DexFileReader {
    ...
    dex_files: Vec<crate::rusty_dex::dex::file::DexFile>,
...
impl DexFileReader {
    ...
    pub fn from_file<P: AsRef<Path>>(path: P) -> DexResult<Self> {
        ...
        let mut archive = crate::rusty_dex::dex::reader::DexArchive::open(&path_str)?;
                    ...
                    crate::profile_scope!("frontend.apk.extract_dex_entry", archive.next())
                {
                    ...
                    jobs.push(scope.spawn(move || {
                        crate::profile_scope!("frontend.apk.metadata_entry", {
                            crate::rusty_dex::dex::file::DexFile::build_metadata(reader)
                        })
                    }));
                }
                jobs.into_iter()
    ...
    pub fn from_raw_dex_file<P: AsRef<Path>>(path: P) -> DexResult<Self> {
        ...
        let readers = crate::rusty_dex::dex::reader::DexReader::build_from_file(path)?;
        let mut dex_files = Vec::new();
        for reader in readers {
            dex_files.push(crate::rusty_dex::dex::file::DexFile::build_metadata(reader)?);
        }
    ...
    pub fn from_bytes(data: &[u8]) -> DexResult<Self> {
        let reader = crate::rusty_dex::dex::reader::DexReader::build(data.to_vec())?;
        let dex = crate::rusty_dex::dex::file::DexFile::build_metadata(reader)?;
        Ok(Self::new(vec![dex]))
    }

    /// Create from existing DexFile structures
    fn new(dex_files: Vec<crate::rusty_dex::dex::file::DexFile>) -> Self {
    ...
    pub(crate) fn visit_member_declarations(
        ...
        use crate::rusty_dex::dex::declarations::{
    ...
    pub(crate) fn find_references(
        ...
        use crate::rusty_dex::dex::references::{DexCodeReference, DexReferenceScanner};
    ...
    fn load_class_from_def(
        &self,
        id: u32,
        class_def: &crate::rusty_dex::dex::classes::ClassDefItem,
        dex: &crate::rusty_dex::dex::file::DexFile,
    ) -> DexResult<ClassNode> {
    ...
    fn load_field(
        &self,
        id: u32,
        encoded: &crate::rusty_dex::dex::classes::EncodedField,
    ) -> DexResult<FieldNode> {
    ...
    fn load_method(
        ...
        id: u32,
        declaring_class: &str,
        encoded: &crate::rusty_dex::dex::classes::EncodedMethod,
        dex: &crate::rusty_dex::dex::file::DexFile,
    ...
    fn load_code_item(
        &self,
        code_item: &crate::rusty_dex::dex::code_item::CodeItem,
...
fn convert_debug_info(info: &crate::rusty_dex::dex::debug_info::DebugInfo) -> DexResult<DebugInfo> {
    let local_vars = info
        .local_vars
        .iter()
        .map(|var| {
...
impl DexFileReader {
    ...
    pub fn get_string(
        ...
        dex_idx: usize,
        idx: u32,
    ) -> Option<&crate::rusty_dex::dex::strings::DexString> {
...
fn build_class_metadata(class_def: &crate::rusty_dex::dex::classes::ClassDefItem) -> ClassMetadata {
    ClassMetadata {
...
fn convert_annotations(
    annotations: &[crate::rusty_dex::dex::classes::DexAnnotation],
...
fn reference_matches(
    ...
    reference: crate::rusty_dex::dex::references::DexCodeReference<'_>,
) -> bool {
    use crate::rusty_dex::dex::references::DexReferenceKind;
...
fn reference_candidates<'a>(
    dex: &'a crate::rusty_dex::dex::file::DexFile,
    target: &DexReferenceTarget,
