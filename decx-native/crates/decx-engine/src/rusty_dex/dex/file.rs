...
use crate::rusty_dex::dex::classes::{ClassDecodeLevel, ClassDefItem, DexClasses, EncodedMethod};
use crate::rusty_dex::dex::code_item::CodeItem;
use crate::rusty_dex::dex::fields::DexFields;
use crate::rusty_dex::dex::header::DexHeader;
...
impl DexFile {
    ...
    pub fn merge(readers: Vec<DexReader>) -> Result<Self, DexError> {
        ...
        Ok(DexFile {
            ...
            protos: DexProtos {
                items: proto_ids_list,
            },
            fields: DexFields {
                items: field_ids_list,
            },
            methods: DexMethods {
                items: method_ids_list,
            },
            classes: DexClasses {
                items: class_defs_list,
            },
        })
    }
